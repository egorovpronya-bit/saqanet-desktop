...
const Map<String, OrgIconData> organizationData = {
  ...
  "azure": OrgIconData(Icons.cloud, const Color(0xFF0078D4)),
  "amazon": OrgIconData(Icons.cloud, const Color(0xFFFF9900)),
  "oracle": OrgIconData(Icons.cloud, const Color(0xFFC74634)),
