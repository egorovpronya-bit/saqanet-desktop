...
final _downArrow = SizedBox(width: _expandIconWidth, child: FaIcon(FontAwesomeIcons.caretDown, size: 14));
final _rightArrow = SizedBox(width: _expandIconWidth, child: FaIcon(FontAwesomeIcons.caretRight, size: 14));
